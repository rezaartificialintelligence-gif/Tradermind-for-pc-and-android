      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {dayData.length === 0 ? (
            ...
            <>
              <div className="tradermind-chart"><ResponsiveContainer width="100%" height={190}>
                <BarChart data={dayData} margin={{ top: 5, right: 5, bottom: 5, left: -22 }}>
                  ...
                  <XAxis dataKey="name" tick={{ fontSize: 11, fill: 'hsl(var(--muted-foreground))', fontWeight: 500 }} tickLine={false} axisLine={false} />
                  <YAxis tick={{ fontSize: 10, fill: 'hsl(var(--muted-foreground))', fontWeight: 500 }} tickLine={false} axisLine={false} unit="٪" domain={[0, 100]} />
                  <Tooltip content={<BarTooltip />} />
                  <Bar dataKey="نرخ برد" radius={[6, 6, 2, 2]} activeBar={{ fillOpacity: 1 }}>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {hourData.length === 0 ? (
            ...
            <>
              <div className="tradermind-chart"><ResponsiveContainer width="100%" height={175}>
                <BarChart data={hourData} margin={{ top: 5, right: 5, bottom: 5, left: -22 }}>
                  ...
                  <YAxis tick={{ fontSize: 10, fill: 'hsl(var(--muted-foreground))', fontWeight: 500 }} tickLine={false} axisLine={false} unit="٪" domain={[0, 100]} />
                  <Tooltip content={<BarTooltip />} />
                  <Bar dataKey="نرخ برد" radius={[5, 5, 2, 2]} activeBar={{ fillOpacity: 1 }}>
      ...
      <Card>
        ...
        <CardContent>
          {equityCurve.length < 2 ? (
            ...
            <div className="tradermind-chart"><ResponsiveContainer width="100%" height={240}>
              <LineChart data={equityCurve} margin={{ top: 10, right: 16, bottom: 10, left: 8 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border) / 0.45)" vertical={false} />
                <XAxis
                  dataKey="index"
                  tick={{ fontSize: 10, fill: 'hsl(var(--muted-foreground))', fontWeight: 500 }} tickLine={false} axisLine={false}
                  label={{ value: 'شماره معامله', position: 'insideBottomRight', offset: -5, fontSize: 9 }}
                />
                <YAxis tick={{ fontSize: 10, fill: 'hsl(var(--muted-foreground))', fontWeight: 500 }} tickLine={false} axisLine={false} />
                ...
                <Line
                  ...
                  strokeWidth={2.5}
                  dot={equityCurve.length <= 40 ? { r: 2.5, strokeWidth: 1.5, fill: "hsl(var(--card))" } : false}
          ...
          <CardContent>
            <div className="tradermind-chart"><ResponsiveContainer width="100%" height={175}>
              <BarChart data={equityCurve} margin={{ top: 5, right: 10, bottom: 5, left: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border) / 0.45)" vertical={false} />
                <XAxis dataKey="index" tick={{ fontSize: 9, fill: 'hsl(var(--muted-foreground))', fontWeight: 500 }} tickLine={false} axisLine={false} />
                <YAxis tick={{ fontSize: 10, fill: 'hsl(var(--muted-foreground))', fontWeight: 500 }} tickLine={false} axisLine={false} />
                <Tooltip
                  content={({ active, payload }) => {
                    if (!active || !payload?.length) return null;
                ...
                />
                <Bar dataKey="pnl" name="P/L" radius={[4, 4, 2, 2]} activeBar={{ fillOpacity: 1 }}>
                  {equityCurve.map((d, i) => (
